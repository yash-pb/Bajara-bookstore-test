            ...
            <div class="">
                @if (Auth::user())
                    <a href="{{ route('user.logout') }}"
                        class="font-medium text-blue-600 hover:underline">Log out</a>
                @else
...
<div class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900 hidden lg:block z-10">
   ...
   <a href="{{ route('admin.livewire.books.list') }}">
      <div
         class="{{ request()->routeIs('books') ? 'bg-blue-600' : '' }} p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
